# Выпуск №4. 23 февраля 2016

Редакторы кода, разработка на мобильных устройствах, верстка писем, CSS-переменные, управление загрузкой CSS.
...
## Альтернативная подгрузка стилей (47:20)
...
## Примеры использования `calc()` (52:15)
