...
## Очень ждём `font-display` (40:25)

- [`font-display` for the Masses](https://css-tricks.com/font-display-masses/)
- [Font Face Observer](https://fontfaceobserver.com/)

## Лия Веру и HTML (44:12)
